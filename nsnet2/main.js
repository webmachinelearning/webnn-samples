...
const denoisedAudioPlayer =
    new AudioPlayer(sampleRate, playDenoisedButton, 'the denoised audio');
const originalAudioPlayer =
    new AudioPlayer(sampleRate, playOriginalButton, 'the original audio');
