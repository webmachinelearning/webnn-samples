...
export class TransferStyle {
  ...
  getInputTensor_() {
    ...
    const tensor = new Float32Array(
        this.inputSize_.slice(1).reduce((a, b) => a * b));

    this.inputElement_.width = this.inputElement_.videoWidth ||
        this.inputElement_.naturalWidth;
    this.inputElement_.height = this.inputElement_.videoHeight ||
        this.inputElement_.naturalHeight;
